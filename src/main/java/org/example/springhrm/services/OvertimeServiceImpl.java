...
public class OvertimeServiceImpl implements  OvertimeService{
    ...
    public Response edit(OvertimeForm form) {
        try {
            ...
            overtime.get().setReason(form.getReason());
            overtime.get().setDuration( form.getEndTime().getHours()+ form.getEndTime().getMinutes()/60 - form.getStartTime().getHours() +form.getStartTime().getMinutes()/60);
            overtime.get().setStartTime(form.getStartTime());
            overtime.get().setEndTime(form.getEndTime());
